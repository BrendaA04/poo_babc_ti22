...
|17|profesor.py|Importa la clse persona del archovo persona.py y se crea la clase profesor que hereda de la clase persona, llamando a un contructor de clase persona |
